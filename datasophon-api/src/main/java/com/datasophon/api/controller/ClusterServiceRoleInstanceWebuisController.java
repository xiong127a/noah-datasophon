...
public class ClusterServiceRoleInstanceWebuisController {
    ...
    public ClusterServiceRoleInstanceWebuisController(ClusterServiceRoleInstanceWebuisService clusterServiceRoleInstanceWebuisService) {
        this.clusterServiceRoleInstanceWebuisService = clusterServiceRoleInstanceWebuisService;
    }
