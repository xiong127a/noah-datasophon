...
public class ClusterYarnSchedulerController {
     ...
     */
    @RequestMapping("/get")
    public Result<ClusterYarnSchedulerVO> getScheduler(@ClusterId Long clusterId) {
        try {
     ...
     */
    @RequestMapping("/list")
    public Result<List<ClusterYarnSchedulerVO>> list(@ClusterId Long clusterId) {
        try {
    ...
    public Result<ClusterYarnSchedulerVO> createDefault(@ClusterId Long clusterId) {
        try {
