...
# Bolt connector
server.bolt.enabled=${neo4jBoltEnabled}
#server.bolt.tls_level=DISABLED
server.bolt.listen_address=:${neo4jBoltPort}
#server.bolt.advertised_address=:7687

# HTTP Connector. There can be zero or one HTTP connectors.
server.http.enabled=${neo4jHttpEnabled}
server.http.listen_address=:${neo4jHttpPort}
#server.http.advertised_address=:7474

# HTTPS Connector. There can be zero or one HTTPS connectors.
server.https.enabled=${neo4jHttpsEnabled}
server.https.listen_address=:${neo4jHttpsPort}
