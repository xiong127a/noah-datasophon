...
export const API_PATHS_V1 = {
  ...
  // Kubernetes Dashboard - v1
  K8S_NAMESPACES: `${API_BASE}/kubernetes/dashboard/namespaces`,
  K8S_PODS: `${API_BASE}/kubernetes/dashboard/pods`,
  K8S_SERVICES: `${API_BASE}/kubernetes/dashboard/services`,
  K8S_DEPLOYMENTS: `${API_BASE}/kubernetes/dashboard/deployments`,
  K8S_CONFIGMAPS: `${API_BASE}/kubernetes/dashboard/configmaps`,
  K8S_SECRETS: `${API_BASE}/kubernetes/dashboard/secrets`,
  K8S_DAEMONSETS: `${API_BASE}/kubernetes/dashboard/daemonsets`,
  K8S_STATEFULSETS: `${API_BASE}/kubernetes/dashboard/statefulsets`,
  K8S_REPLICASETS: `${API_BASE}/kubernetes/dashboard/replicasets`,
  K8S_REPLICATIONCONTROLLERS: `${API_BASE}/kubernetes/dashboard/replicationcontrollers`,
  K8S_JOBS: `${API_BASE}/kubernetes/dashboard/jobs`,
  K8S_CRONJOBS: `${API_BASE}/kubernetes/dashboard/cronjobs`,
  K8S_PERSISTENTVOLUMES: `${API_BASE}/kubernetes/dashboard/persistentvolumes`,
  K8S_PVCS: `${API_BASE}/kubernetes/dashboard/pvcs`,
  ...
  K8S_RESOURCE_EVENTS: `${API_BASE}/kubernetes/dashboard/resource/events`,
