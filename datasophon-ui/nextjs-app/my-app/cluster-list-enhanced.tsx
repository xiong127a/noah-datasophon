...
import ClusterAuthorizationDialog from "./cluster-authorization-dialog"
import CreateClusterDialog from "./create-cluster-dialog"
import { apiClient, API_PATHS } from "@/lib/api-config" // 导入API配置
...
const ClusterCard = ({ cluster, onEnter, onEdit, onAuth, onDelete }: { 
  ...
  return (
    <>
      ...
      {/* 授权弹窗 */}
      <ClusterAuthorizationDialog open={authDialogOpen} onOpenChange={setAuthDialogOpen} clusterName={cluster.clusterName} />
    </>
  )
}
