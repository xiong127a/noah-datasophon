...
export const SERVICE_HA_MODES = {
  ...
  'ELASTICSEARCH': [HA_MODE.STANDALONE, HA_MODE.CLUSTER],  // ElasticSearch支持单节点和集群模式
  'CLICKHOUSE': [HA_MODE.STANDALONE, HA_MODE.CLUSTER],  // ClickHouse支持单节点和集群模式
  'DORIS': [HA_MODE.STANDALONE, HA_MODE.ZOOKEEPER_HA]  // Doris支持单节点和FE高可用模式
  // 可以继续添加其他服务支持的高可用模式
};
