  ...
  <div class="resource-list">
    ...
    <div class="kubernetes-dashboard-card kubernetes-resource-card">
      <div class="kubernetes-card-header">
        <span class="kubernetes-card-title">StatefulSets</span>
  ...
  methods: {
    ...
    async fetchStatefulSets() {
      ...
      try {
        ...
        // 使用全局API对象中定义的getKubernetesStatefulSets接口
        const res = await this.$axiosGet(global.API.getKubernetesStatefulSets, params);
