  ...
  <div class="resource-list">
    ...
    <div class="k8s-dashboard-card k8s-resource-card">
      <div class="k8s-card-header">
        <span class="k8s-card-title">Replication Controllers</span>
  ...
  methods: {
    ...
    async fetchReplicationControllers() {
      ...
      try {
        ...
        // 使用全局API对象中定义的getK8sReplicationControllers接口
        const res = await this.$axiosGet(global.API.getK8sReplicationControllers, params);
