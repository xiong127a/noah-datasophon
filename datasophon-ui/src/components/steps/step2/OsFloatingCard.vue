...
export default {
  ...
  methods: {
    ...
    getGpuDisplayInfo() {
      ...
      if (this.osInfo.gpuInfo.vendor === '未检测到') {
        return "未检测到图形处理器";
      }
    ...
    getGpuStatus() {
      ...
      // 特殊处理Alpine和CentOS系统的"未检测到"状态，显示为success而不是loading
      if (this.osInfo && this.osInfo.gpuInfo && 
          this.osInfo.gpuInfo.vendor === '未检测到' && 
          this.osInfo.gpuInfo.statusMessage === 'GPU信息加载完成') {
        return 'success';
      }
