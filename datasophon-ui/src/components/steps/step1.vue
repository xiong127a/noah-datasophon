                        ...
                        >
                          <div class="namespace-item">
                            <svg class="namespace-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9 2C5.13 2 2 3.5 2 5.5V12.5C2 14.5 5.13 16 9 16C12.87 16 16 14.5 16 12.5V5.5C16 3.5 12.87 2 9 2Z" fill="#E8F4FC" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M2 9C2 11 5.13 12.5 9 12.5C12.87 12.5 16 11 16 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M2 5.5C2 7.5 5.13 9 9 9C12.87 9 16 7.5 16 5.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.5"/>
                            </svg>
