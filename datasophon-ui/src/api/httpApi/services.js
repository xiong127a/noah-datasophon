...
export default {
  ...
  getServiceConfigOption: path + '/api/service/install/getServiceConfigOption', // 查询服务配置
  ...
  saveServiceRoleHostMapping: path + '/api/service/install/saveServiceRoleHostMapping', // 保存服务角色与主机对应关系 
  getNonMasterRoleList: path + '/api/frame/service/role/getNonMasterRoleList', // 查询服务对应的非Master角色 
  saveServiceConfig: path + '/api/service/install/saveServiceConfig', // 保存服务配置
  ...
  getLog: path + '/api/cluster/service/role/instance/getLog', // 服务实例-查看日志
  getHostCommandLog: path + '/api/cluster/service/command/host/command/getHostCommandLog', // 查询主机上服务角色指令3日志
  getQueueList: path + '/api/cluster/yarn/queue/list', // 队列列表
  getCapacityList: path + '/api/cluster/queue/capacity/list', // 容量队列列表
  saveQueue: path + '/api/cluster/yarn/queue/save', // 队列保存
  deleteQueue: path + '/api/cluster/yarn/queue/delete', // 队列删除
  updateQueue: path + '/api/cluster/yarn/queue/update', // 更新队列
  refreshQueues: path + '/api/cluster/yarn/queue/refreshQueues', // 刷新队列到Yarn
  refreshQueuesYARN : path + '/api/cluster/queue/capacity/refreshToYarn',
  getConnectionInfo: path + '/api/cluster/service/instance/getConnectionInfo', // 获取服务连接信息
  getServiceDoc: path + '/api/doc/getServiceDoc', // 获取服务文档（组件介绍/用户指南/帮助文档）
  getDocImage: path + '/api/doc/image', // 获取文档中的图片资源
