...
/**
 * Prometheus集成服务
 * 替代PrometheusActor，使用Spring Service实现
 */
public interface PrometheusIntegrationService {
    
    /**
     * 生成Prometheus配置
     */
    void generatePrometheusConfig(GeneratePrometheusConfigCommand command);
