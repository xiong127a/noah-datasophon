...
public class UbuntuSELinuxChecker extends GenericSELinuxChecker {
        ...
        public CheckItem check(HostInfo hostInfo, CheckItem checkItem, CheckLogger cacheLog) {
                ...
                try {
                        ...
                        String apparmorStatus = apparmorStatusResult.isSuccess()
                                        ? apparmorStatusResult.getOutput().trim()
                                        : "未知";
                        ...
                        CommandResult selinuxModuleResult = execCommand(session,
                                        "lsmod | grep selinux || echo '未加载SELinux模块'");
