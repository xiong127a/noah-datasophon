...
/**
 * 集群节点标签转换器
 * 负责ClusterNodeLabelEntity、DTO、VO之间的转换
 *
 * @author 任相鹏
...
public interface ClusterNodeLabelConverter extends
        BaseConverter<ClusterNodeLabelEntity, ClusterNodeLabelDTO, ClusterNodeLabelVO> {
}