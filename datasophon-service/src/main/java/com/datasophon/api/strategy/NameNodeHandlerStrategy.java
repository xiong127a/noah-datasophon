...
public class NameNodeHandlerStrategy extends ServiceHandlerAbstract implements ServiceRoleStrategy {
        ...
        private String generateJavaCode(String hdfsUri, boolean enableKerberos) {
                ...
                code.append("// HDFS Java API 示例代码\n")
                                ...
                                .append("// <dependencies>\n")
                                .append("//     <dependency>\n")
                                .append("//         <groupId>org.apache.hadoop</groupId>\n")
                                .append("//         <artifactId>hadoop-client</artifactId>\n")
                                .append("//         <version>3.3.3</version>\n")
                                .append("//     </dependency>\n")
                                .append("//     <dependency>\n")
                                .append("//         <groupId>org.apache.hadoop</groupId>\n")
                                .append("//         <artifactId>hadoop-common</artifactId>\n")
                                .append("//         <version>3.3.3</version>\n")
                                .append("//     </dependency>\n")
                                .append("//     <dependency>\n")
                                .append("//         <groupId>org.apache.hadoop</groupId>\n")
                                .append("//         <artifactId>hadoop-hdfs</artifactId>\n")
                                .append("//         <version>3.3.3</version>\n")
                                .append("//     </dependency>\n")
                                .append("// </dependencies>\n\n")
        ...
        private String generatePythonCode(String hdfsUri, boolean enableKerberos) {
                ...
                code.append("# HDFS Python API 示例代码\n")
                                .append("# 安装依赖:\n")
                                .append("# pip install pyarrow==10.0.0\n")
                                .append("# pip install hdfs==2.7.0\n")
                                .append("# pip install pydoop==2.0.0   # 如需更底层的HDFS访问\n\n");
                ...
                code.append("# 使用 PyArrow 操作 HDFS\n")
                                ...
                                .append("    host=\"").append(hdfsUri.replace("hdfs://", "").split(":")[0])
                                .append("\",\n")
                                .append("    port=")
                                .append(hdfsUri.split(":").length > 2 ? hdfsUri.split(":")[2] : "8020")
                                .append(",\n");
