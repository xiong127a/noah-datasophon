...
public class K8sServiceScaleUpHandler extends ServiceHandler {

    private static final Logger logger = LoggerFactory.getLogger(K8sServiceScaleUpHandler.class);

    @Override
    public ExecResult handlerRequest(ServiceRoleInfo serviceRoleInfo) throws Exception {
        logger.info("start to scale up service role {}", serviceRoleInfo.getName());
        ...
        k8sServiceScaleCommand.setScaleType(K8sScaleType.SCALE_UP);
