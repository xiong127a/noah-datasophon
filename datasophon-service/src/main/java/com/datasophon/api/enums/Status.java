...
public enum Status {
    ...
    BASIC_SERVICE_SELECT_MOST_ONE_HOST(10035,
            "Prometheus(master role)/AlertManager/Grafana must be deployed on the same host",
            "Prometheus主角色/AlertManager/Grafana必须部署在同一台主机上，NodeExporter可以部署在任意主机"),
