package com.datasophon.api.utils.SevenZip;
...
public class LzmaBench
{
	...
	{
		public com.datasophon.api.utils.SevenZip.CRC CRC = new CRC();
	...
	static class CProgressInfo implements com.datasophon.api.utils.SevenZip.ICodeProgress
	{
	...
	static public int LzmaBenchmark(int numIterations, int dictionarySize) throws Exception
	{
		...
		com.datasophon.api.utils.SevenZip.Compression.LZMA.Encoder encoder = new com.datasophon.api.utils.SevenZip.Compression.LZMA.Encoder();
		com.datasophon.api.utils.SevenZip.Compression.LZMA.Decoder decoder = new com.datasophon.api.utils.SevenZip.Compression.LZMA.Decoder();
		...
		rg.Set(kBufferSize);
		rg.Generate();
		com.datasophon.api.utils.SevenZip.CRC crc = new com.datasophon.api.utils.SevenZip.CRC();
		crc.Init();
