...
public class OpenldapHandlerStrategy extends AbstractHandlerStrategy implements ServiceRoleStrategy {
    ...
    public ExecResult handler(ServiceRoleOperateCommand command) throws SQLException, ClassNotFoundException {
        ...
        if (command.getCommandType().equals(CommandType.INSTALL_SERVICE)) {
            // 安装服务
            ExecResult execResult = ShellUtils.exceShell("yum -y install openldap compat-openldap openldap-clients openldap-servers openldap-servers-sql openldap-devel migrationtools");
