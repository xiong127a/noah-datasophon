    ...
    public ExecResult handler(ServiceRoleOperateCommand command) throws SQLException, ClassNotFoundException {
        ...
        if (command.getEnableKerberos()) {
            ...
            if (!FileUtil.exist(hadoopConfDir + "ssl-server.xml")) {
                ShellUtils.execShell("cp " + hadoopConfDir + "ssl-server.xml.template " + hadoopConfDir + "ssl-server.xml");
            }
            if (!FileUtil.exist(hadoopConfDir + "ssl-client.xml")) {
                ShellUtils.execShell("cp " + hadoopConfDir + "ssl-client.xml.template " + hadoopConfDir + "ssl-client.xml");
            }
