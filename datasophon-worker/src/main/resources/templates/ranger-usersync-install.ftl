...
# Must specify a value if SYNC_SOURCE is ldap
SYNC_LDAP_BIND_DN = ${syncLdapBindDn}
...
SYNC_LDAP_BIND_PASSWORD = ${syncLdapBindPassword}
...
SYNC_LDAP_SEARCH_BASE = ${syncLdapSearchBase}

# search base for users
# sample value would be ou=users,dc=hadoop,dc=apache,dc=org
# overrides value specified in SYNC_LDAP_SEARCH_BASE
SYNC_LDAP_USER_SEARCH_BASE = ${syncLdapUserSearchBase}
