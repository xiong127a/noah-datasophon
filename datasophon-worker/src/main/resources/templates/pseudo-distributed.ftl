...
[desktop]
  ...
  secret_key=b0e90bc319c9b817e7d41c03fb82195d
  ...
  default_hdfs_superuser=${defaultHdfsSuperuser}
...
[hadoop]
  ...
  [[yarn_clusters]]
    ...
    [[[default]]]
      ...
      resourcemanager_host=${resourcemanagerHost}
      ...
      history_server_api_url=${historyServerApiUrl}

      # URL of the Spark History Server
      spark_history_server_url=${sparkHistoryServerUrl}
...
[beeswax]
  ...
  hive_server_host=${hiveServerHost}

  # Port where HiveServer2 Thrift server runs on.
  hive_server_port=${hiveServerPort}
