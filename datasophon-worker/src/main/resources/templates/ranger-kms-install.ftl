...
#
db_name=${rangerKmsDbName}
db_user=${rangerKmsDbUser}
db_password=${rangerKmsDbPass}
...
#
#POLICY_MGR_URL=http://192.168.1.54:6080
...
#
#REPOSITORY_NAME=kmsdev
REPOSITORY_NAME=${rangerKmsRepositoryName}
...
RANGER_KMS_LOG_DIR=/opt/datasophon/ranger/ranger-2.1.0-kms/log

#PID file path
RANGER_KMS_PID_DIR_PATH=/opt/datasophon/ranger/ranger-2.1.0-kms/pid
