...
--rocksdb_batch_size=${rocksdbBatchSize}
# The default block cache size used in BlockBasedTable.
# The unit is MB.
--rocksdb_block_cache=${rocksdbBlockCache}
...
--rocksdb_compression_per_level=${rocksdbCompression}
...
--rocksdb_db_options=${rocksdbDbOptions}
# rocksdb ColumnFamilyOptions in json, each name and value of option is string, given as "option_name":"option_value" separated by comma
--rocksdb_column_family_options=${rocksdbColumnFamilyOptions}
# rocksdb BlockBasedTableOptions in json, each name and value of option is string, given as "option_name":"option_value" separated by comma
--rocksdb_block_based_table_options=${rocksdbBlockBasedTableOptions}
...
--num_max_connections=${storageNumMaxConnections}
# Worker threads number to handle request
--num_worker_threads=${storageNumWorkerThreads}
# Maximum subtasks to run admin jobs concurrently
--max_concurrent_subtasks=${maxConcurrentSubtasks}
...
--memory_tracker_limit_ratio=${storageMemoryTrackerLimitRatio}
# untracked reserved memory in Mib
--memory_tracker_untracked_reserved_memory_mb=${storageMemoryTrackerUntrackedReservedMemoryMb}
...
--memory_purge_enabled=${storageMemoryPurgeEnabled}
# memory background purge interval in seconds
--memory_purge_interval_seconds=${storageMemoryPurgeIntervalSeconds}