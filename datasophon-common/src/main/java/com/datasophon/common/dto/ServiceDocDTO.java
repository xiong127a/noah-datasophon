...
public record ServiceDocDTO(
     ...
     * 创建基础文档DTO
     */
    public static ServiceDocDTO of(Long clusterId, Long serviceId, String serviceName, String docType) {
     ...
     * 创建包含内容的文档DTO
     */
    public static ServiceDocDTO withContent(Long clusterId, Long serviceId, String serviceName,
