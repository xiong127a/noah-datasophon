    ...
    public void getConfig(Integer clusterId, List<ServiceConfig> list) {
        ...
        for (ServiceConfig config : list) {
            if ("hive.metastore.uris".equals(config.getName())) {
                ...
                logger.info("检测到hive.metastore.uris，将值从 {} 更新为 K8S 服务地址 {}", config.getValue(), finalUris);
                ...
                logger.info("检测到hive.zookeeper.quorum，将值从 {} 更新为 K8S 服务地址 {}", config.getValue(), zkServers.toString());
